      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .site-shell {
          min-height: 100vh;
          background:
            radial-gradient(circle at 12% 8%, rgba(124, 58, 237, 0.42), transparent 30%),
            radial-gradient(circle at 88% 0%, rgba(20, 184, 166, 0.35), transparent 28%),
            radial-gradient(circle at 55% 45%, rgba(249, 115, 22, 0.12), transparent 32%),
            linear-gradient(180deg, #070A12 0%, #0F172A 45%, #080B13 100%);
          overflow-x: hidden;
        }

        .hero {
          position: relative;
          padding: clamp(4rem, 10vw, 7rem) 1.25rem 3rem;
        }
        ...
        .visual-panel-grid {
          ...
          grid-template-rows: 150px 110px 120px;
          gap: .85rem;
        }
        ...
        .content-area {
          max-width: 1180px;
          margin: 0 auto;
          padding: 1rem 1.25rem clamp(3rem, 8vw, 6rem);
          display: grid;
          gap: 1.2rem;
        }
        ...
        @media (max-width: 900px) {
          .hero-inner, .section-layout { grid-template-columns: 1fr; }
          .overview-grid { grid-template-columns: repeat(2, 1fr); }
        }

        @media (max-width: 560px) {
          .overview-grid { grid-template-columns: 1fr; }
          .visual-panel-grid { grid-template-columns: 1fr; grid-template-rows: auto; }
          .tile-large, .tile-wide { grid-column: auto; grid-row: auto; min-height: 130px; }
          ...
          <aside className="visual-panel" aria-label="Visual hierarchy preview">
            <div className="visual-panel-grid">
              <div className="tile tile-large">
                ...
                <span>Big idea first. Details after.</span>
              </div>
              <div className="tile">
                <strong>Contrast</strong>
                <span>Priority becomes visible.</span>
              </div>
              <div className="tile">
                <strong>Spacing</strong>
                <span>Relationships become clear.</span>
              </div>
              <div className="tile tile-wide">
                <strong>Audience Fit</strong>
                <span>The same message changes depending on who is looking.</span>
              </div>
            </div>
          </aside>
        </div>
